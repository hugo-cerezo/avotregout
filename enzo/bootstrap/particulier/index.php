    ...
    <main  id="main">
        <section class="d-flex p-3">
            <div class=" col mb-4 landing" style="cursor:pointer;">
                <!-- <div class="shadow p-3 mb-5 bg-white rounded card h-100"> -->
                <div class="shadow-sm p-3 mb-5 bg-white rounded card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body" >
                        <h5 class="titlemain card-title">Particulier</h5>
            ...
            <div class="col mb-4 landing" style="cursor:pointer;">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h5 class="titlemain card-title">Professionnel</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    </div>
                </div>
            </div>
            <div id="evenements" class="col mb-4 navLink" style="cursor:pointer;">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h5 class="titlemain card-title">Créateur d'évenements</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    </div>
                </div>
            </div>
            <div class="col mb-4">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h5 class="titlemain card-title">Actualitées</h5>
                        <div class="col">
                            <h6>News Facebook</h6>
                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <h6>News Admin</h6>
        ...
        <section>
            <div class="col mb-4">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h5 class="titlemain card-title">Galerie</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="col mb-4">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h5 class="titlemain card-title">Devis</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    </div>
                </div>
            </div>
