            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    $('.editLink').click(function () {
                        ...
                        $(this).parent().append('<div id="editBox"><button class="col-1 articleup">Up</button><button class="col-1 articledown">Down</button><button id="' + $(this).parent().attr('id') + '" class="editField col-1">Valider</button><button class="editDelete">Supprimer</button><button class="editCancel col-1">Annuler</button></div>');
                        // Supression de l'option up si premier de la liste
                    ...
                    $('#main').append('<button id="addArticle">Ajouter un article</button>');
                    $("#addArticle").click(function () {
                        $('#addArticle').remove();
                        $('#main').append('<div id="newArticle"><h5>Titre</h5><div style="border: 1px solid black" class="contentEditable mb-5" name="newTitle" id="newTitle" contentEditable></div><h5>Texte</h5><div style="border: 1px solid black" class="contentEditable mb-5" name="newText" id="newText" contentEditable></div><button class="addNewArticle">Ajouter</button><button class="editCancel">Annuler</button></div>');
                        // Envoie du form
